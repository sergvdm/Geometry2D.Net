namespace Altium.Geometry2D.Shapes
{
    ...
    {
        public BeveledRectangle(Point2DD vertex0, Point2DD vertex2, double beveling, ShapeBevelingMode bevelingMode, double rotation)
     : this(new BeveledRectInitData(vertex0, vertex2, beveling, bevelingMode, rotation))
        {
        }

        public BeveledRectangle(Point2DD center, double width, double height, double beveling, ShapeBevelingMode bevelingMode, double rotation)
    ...
    {
        public BeveledRectInitData(Point2DD vertex0, Point2DD vertex2, double beveling, ShapeBevelingMode bevelingMode, double rotation)
        {
        ...
        public BeveledRectInitData(Point2DD center, double width, double height, double beveling, ShapeBevelingMode bevelingMode, double rotation)
        {

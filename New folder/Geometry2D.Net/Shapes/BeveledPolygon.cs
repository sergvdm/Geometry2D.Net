...
namespace Altium.Geometry2D.Shapes
{
    ...
    {
        public BeveledPolygon(double beveling, ShapeBevelingMode bevelingMode, params Point2DD[] vertices)
        ...
        public IReadOnlyList<Point2DD> ActualVertices { get; }
    ...
    {
        public BeveledPolyInitData(double beveling, ShapeBevelingMode bevelingMode, params Point2DD[] vertices)
        {
            BevelingMode = bevelingMode;
            Beveling = BevelingMode == ShapeBevelingMode.Percent ? beveling.LimitRange(0, 100) : Math.Abs(beveling);
            Vertices = vertices;
            ActualVertices = new Point2DD[Vertices.Length * 2];
        ...
        public Point2DD[] Vertices { get; private set; }
        public Point2DD[] ActualVertices { get; private set; }
    }
}

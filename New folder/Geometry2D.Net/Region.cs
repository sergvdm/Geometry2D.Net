...
namespace Altium.Geometry2D
{
    internal class Region : LimitedShape, IRegion
    {
        ...
        public Region(IGeometry2DEngine geometry2DEngine, IEnumerable<IPath> paths)
        {
        ...
        public bool IsInnerPoint(Point2DD point, bool includeCoincident) => Paths.Any(x => x.IsInnerPoint(point, includeCoincident));

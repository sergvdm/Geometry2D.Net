...
namespace Svd.Geometry2D
{
    ...
    public static class Math2D
    {
        ...
        public static Point2DD Round(this Point2DD pt, int precision)
        {
            return new Point2DD(Round(pt.X, precision), Round(pt.Y, precision));
        }

        public static Vector2DD Round(this Vector2DD v, int precision)
        {
            return new Vector2DD(Round(v.X, precision), Round(v.Y, precision));
        }

        public static AARect2DD Round(this AARect2DD r, int precision)
        {
            return new AARect2DD(r.LB.Round(precision), r.RT.Round(precision));
        }

        public static Point2DD Min(Point2DD point1, Point2DD point2)
        {
            return new Point2DD(Math.Min(point1.X, point2.X), Math.Min(point1.Y, point2.Y));
        }

        public static Point2DD Max(Point2DD point1, Point2DD point2)
        {
            return new Point2DD(Math.Max(point1.X, point2.X), Math.Max(point1.Y, point2.Y));
        }
        ...
        public static double DistanceTo(this Point2DD pt1, Point2DD pt2)
        {
            double dx = pt2.X - pt1.X, dy = pt2.Y - pt1.Y;
            return Math.Sqrt(dx * dx + dy * dy);
        }

        public static Point2DD ProjectTo(this Point2DD pt, Point2DD lp1, Point2DD lp2)
        {
        ...
        public static Point2DD ProjectTo(this Point2DD pt, ILinearShape line)
        {
            return ProjectTo(pt, line.Point1, line.Point2);
        }

        public static Point2DD MirrorBy(this Point2DD pt, Point2DD mirrorPoint)
        {
            return pt + (mirrorPoint - pt) * 2;
        }

        public static Point2DD MirrorBy(this Point2DD pt, Point2DD lp1, Point2DD lp2)
        {
            var mirrorPoint = pt.ProjectTo(lp1, lp2);
            return pt.MirrorBy(mirrorPoint);
        }

        public static Point2DD MirrorBy(this Point2DD pt, ILinearShape mirrorLine)
        {
        ...
        public static IntersectionResult Intersection(Point2DD l1p1, Point2DD l1p2, Point2DD l2p1, Point2DD l2p2)
        {
            ...
            var ov = new Vector2DD((xmin + xmax) / 2, (ymin + ymax) / 2);
            var p11 = l1p1 - ov;
            var p12 = l1p2 - ov;
            var p21 = l2p1 - ov;
            var p22 = l2p2 - ov;
            ...
            if (double.IsNaN(x) || double.IsInfinity(x) || double.IsNaN(y) || double.IsInfinity(y))
            {
                ...
                {
                    Point1 = p11 + (Point2DD.Zero - p11).ProjectTo(v1) + ov,
                    Point2 = p21 + (Point2DD.Zero - p21).ProjectTo(v2) + ov,
            ...
            return new IntersectionResult
            {
                Point1 = new Point2DD(x, y) + ov,
                Point2 = new Point2DD(x, y) + ov,
                AreIntersected = true
            };
        }
        ...
        public static IntersectionResult Intersection(Point2DD lp1, Point2DD lp2, Point2DD circleCenter, double circleRadius)
        {
            var ov = (Vector2DD)(((lp1 + lp2) / 2 + circleCenter) / 2);
            ...
            else
            {
                ...
                var p1 = c + new Vector2DD(a + halfSweep) * circleRadius;
                var p2 = c + new Vector2DD(a - halfSweep) * circleRadius;
                return new IntersectionResult
                {
                    Point1 = p1 + ov,
                    Point2 = p2 + ov,
        ...
        public static IntersectionResult Intersection(Point2DD circle1Center, double circle1Radius, Point2DD circle2Center, double circle2Radius)
        {
            var ov = (Vector2DD)((circle1Center + circle2Center) / 2);
        ...
        {
            public Point2DD Point1;
            public Point2DD Point2;

namespace Svd.Geometry2D.Shapes
{
    ...
    {
        public RoundedRectangle(Point2DD vertex0, Point2DD vertex2, double rounding, ShapeRoundingMode roundingMode, double rotation)
            : this(new RoundedRectInitData(vertex0, vertex2, rounding, roundingMode, rotation))
        {
        }

        public RoundedRectangle(Point2DD center, double width, double height, double rounding, ShapeRoundingMode roundingMode, double rotation)
    ...
    {
        public RoundedRectInitData(Point2DD vertex0, Point2DD vertex2, double rounding, ShapeRoundingMode roundingMode, double rotation)
        {
        ...
        public RoundedRectInitData(Point2DD center, double width, double height, double rounding, ShapeRoundingMode roundingMode, double rotation)
        {

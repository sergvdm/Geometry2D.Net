...
namespace Svd.Geometry2D
{
    public class Geometry2DEngine : IGeometry2DEngine
    {
        ...
        public Point2DD SnapToGrid(Point2DD point) => point.Round(Settings.Precision);
        public IInfiniteLine CreateInfiniteLine(Point2DD point, Vector2DD vector) => new InfiniteLine(point, vector);
        public IInfiniteLine CreateInfiniteLine(ILinearShape refShape) => CreateInfiniteLine(refShape.Point1, refShape.Vector);
        public IRay CreateRay(Point2DD point, Vector2DD vector) => new Ray(point, vector);
        public IRay CreateRay(ILinearShape refShape) => CreateRay(refShape.Point1, refShape.Vector);
        public ILine CreateLine(Point2DD startPoint, Point2DD endPoint) => new Line(startPoint, endPoint);
        public ILine CreateLine(ILinearShape refShape) => CreateLine(refShape.Point1, refShape.Point1 + refShape.Vector);
        public IArc CreateArc(Point2DD startPoint, Point2DD endPoint, Point2DD pointOnArc) => new Arc(startPoint, endPoint, pointOnArc);
        public IArc CreateArc(Point2DD startPoint, Point2DD endPoint, double radius, bool cw = false, bool longest = false) => new Arc(startPoint, endPoint, radius, cw, longest);
        public IArc CreateArc(Point2DD center, double radius, double startAngle, double sweepAngle) => new Arc(center, radius, startAngle, sweepAngle);
        ...
        public ICircle CreateCircle(Point2DD center, double radius) => new Circle(center, radius);
        public ICircle CreateCircle(ICircularShape refShape) => CreateCircle(refShape.Center, refShape.Radius);
        public IRectangle CreateRectangle(Point2DD center, double width, double height, double rotation = 0) => new Rectangle(center, width, height, rotation);
        public IRectangle CreateRectangle(Point2DD vertex0, Point2DD vertex2, double rotation = 0) => new Rectangle(vertex0, vertex2, rotation);
        ...
        public IRoundedRectangle CreateRoundedRectangle(Point2DD center, double width, double height, double rounding, ShapeRoundingMode roundingMode, double rotation = 0) => new RoundedRectangle(center, width, height, rounding, roundingMode, rotation);
        public IRoundedRectangle CreateRoundedRectangle(Point2DD vertex0, Point2DD vertex2, double rounding, ShapeRoundingMode roundingMode, double rotation = 0) => new RoundedRectangle(vertex0, vertex2, rounding, roundingMode, rotation);
        ...
        public IBeveledRectangle CreateBeveledRectangle(Point2DD center, double width, double height, double beveling, ShapeBevelingMode bevelingMode, double rotation = 0) => new BeveledRectangle(center, width, height, beveling, bevelingMode, rotation);
        public IBeveledRectangle CreateBeveledRectangle(Point2DD vertex0, Point2DD vertex2, double beveling, ShapeBevelingMode bevelingMode, double rotation = 0) => new BeveledRectangle(vertex0, vertex2, beveling, bevelingMode, rotation);
        ...
        public IPolygon CreatePolygon(params Point2DD[] vertices) => new Polygon(vertices);
        public IPolygon CreatePolygon(IEnumerable<Point2DD> vertices) => new Polygon(vertices);
        public IRoundedPolygon CreateRoundedPolygon(double rounding, ShapeRoundingMode roundingMode, params Point2DD[] vertices) => new RoundedPolygon(rounding, roundingMode, vertices);
        public IRoundedPolygon CreateRoundedPolygon(double rounding, ShapeRoundingMode roundingMode, IEnumerable<Point2DD> vertices) => new RoundedPolygon(rounding, roundingMode, vertices.ToArray());
        public IBeveledPolygon CreateBeveledPolygon(double beveling, ShapeBevelingMode bevelingMode, params Point2DD[] vertices) => new BeveledPolygon(beveling, bevelingMode, vertices);
        public IBeveledPolygon CreateBeveledPolygon(double beveling, ShapeBevelingMode bevelingMode, IEnumerable<Point2DD> vertices) => new BeveledPolygon(beveling, bevelingMode, vertices.ToArray());
        ...
        public bool AreCoincident(Point2DD pt1, Point2DD pt2)
        {
            return Math2D.Round(pt1, Precision) == Math2D.Round(pt2, Precision);
        }

        private bool AreInEpsilon(Point2DD pt1, Point2DD pt2) => pt1.DistanceTo(pt2) < Epsilon;

        public bool AreCoincident(Point2DD pt, IInfiniteLine infLine)
        {
            var p = pt.ProjectTo(infLine);
            return AreInEpsilon(pt, p);
        }

        public bool AreCoincident(Point2DD pt, IRay ray)
        {
        ...
        public bool AreCoincident(Point2DD pt, ILine line) => AreCoincident(line, pt);
        public bool AreCoincident(Point2DD pt, ICircle circle) => AreCoincident(circle, pt);
        public bool AreCoincident(Point2DD pt, IArc arc) => AreCoincident(arc, pt);
        public bool AreCoincident(Point2DD pt, IPathSegment segment) => AreCoincident(segment, pt);
        public bool AreCoincident(Point2DD pt, IPath path) => AreCoincident(path, pt);
        public bool AreCoincident(Point2DD pt, IRegion region) => AreCoincident(region, pt);

        public bool AreCoincident(IInfiniteLine infLine, Point2DD pt) => AreCoincident(pt, infLine);
        ...
        public bool AreCoincident(IInfiniteLine infLine, IPathSegment segment)
        {
        ...
        public bool AreCoincident(IInfiniteLine infLine, IPath path)
        {
        ...
        public bool AreCoincident(IRay ray, Point2DD pt) => AreCoincident(pt, ray);
        ...
        public bool AreCoincident(IRay ray, IPathSegment segment)
        {
            if (segment is ILine line)
            {
        ...
        public bool AreCoincident(IRay ray, IPath path)
        {
        ...
        public bool AreCoincident(ILine line, Point2DD pt)
        {
        ...
        public bool AreCoincident(ICircle circle, Point2DD pt)
        {
            var v = new Vector2DD(circle.Center, pt);
        ...
        {
            return AreCoincident(new Point2DD(circle1.Center.X - circle1.Radius, circle1.Center.Y), new Point2DD(circle2.Center.X - circle2.Radius, circle2.Center.Y))
                && AreCoincident(new Point2DD(circle1.Center.X + circle1.Radius, circle1.Center.Y), new Point2DD(circle2.Center.X + circle2.Radius, circle2.Center.Y))
                && AreCoincident(new Point2DD(circle1.Center.X, circle1.Center.Y - circle1.Radius), new Point2DD(circle2.Center.X, circle2.Center.Y - circle2.Radius))
                && AreCoincident(new Point2DD(circle1.Center.X, circle1.Center.Y + circle1.Radius), new Point2DD(circle2.Center.X, circle2.Center.Y + circle2.Radius));
        }

        public bool AreCoincident(ICircle circle, IArc arc) => AreCoincident(arc, circle);

        public bool AreCoincident(ICircle circle, IPathSegment segment)
        {
            if (segment is ILine line)
            {
        ...
        public bool AreCoincident(ICircle circle, IPath path)
        {
        ...
        public bool AreCoincident(IPathSegment segment, Point2DD point)
        {
            if (segment is ILine line)
            {
        ...
        public bool AreCoincident(IPathSegment segment, IInfiniteLine infLine)
        {
            if (segment is ILine line)
            {
        ...
        public bool AreCoincident(IPathSegment segment, IRay ray)
        {
            if (segment is ILine line)
            {
        ...
        public bool AreCoincident(IPathSegment segment1, IPathSegment segment2)
        {
        ...
        public bool AreCoincident(IPathSegment segment, IPath path) => AreCoincident(path, segment);
        public bool AreCoincident(IPathSegment segment, IRegion region) => AreCoincident(region, segment);

        public bool AreCoincident(IPath path, Point2DD point)
        {
        ...
        public bool AreCoincident(IPath path, IInfiniteLine infLine)
        {
            return path.Segments.All(x => AreCoincident(x, infLine));
        }

        public bool AreCoincident(IPath path, IRay ray)
        {
            return path.Segments.All(x => AreCoincident(x, ray));
        }

        public bool AreCoincident(IPath path, IPathSegment segment)
        {
            path = Reduce(path);
            return path.Segments.All(x => AreCoincident(x, segment));
        }

        public bool AreCoincident(IPath path1, IPath path2)
        {
        ...
        private bool AreCoincident(IPath path1, IPath path2, bool reversePath2)
        {
            var result = true;
        ...
        public bool AreCoincident(IPath path, IRegion region) => AreCoincident(region, path);
        ...
        public bool AreCoincident(IRegion region, Point2DD point)
        {
            return region.Paths.Any(x => AreCoincident(x, point));
        }

        public bool AreCoincident(IRegion region, IPathSegment segment)
        {
            return region.Paths.Any(x => AreCoincident(x, segment));
        }

        public bool AreCoincident(IRegion region, IPath path)
        {
        ...
        public ILine ShortestLineBetween(Point2DD pt1, Point2DD pt2)
        {
            return new Line(pt1, pt2);
        }

        public ILine ShortestLineBetween(Point2DD pt, IInfiniteLine line)
        {
            return new Line(pt, pt.ProjectTo(line));
        }

        public ILine ShortestLineBetween(Point2DD pt, IRay line)
        {
        ...
        public ILine ShortestLineBetween(Point2DD pt, ILine line)
        {
            var cp = pt.ProjectTo(line);
        ...
        public ILine ShortestLineBetween(Point2DD pt, ICircle circle)
        {
        ...
        public ILine ShortestLineBetween(Point2DD pt, IArc arc)
        {
        ...
        public ILine ShortestLineBetween(Point2DD pt, IPathSegment segment)
        {
            if (segment is ILine line)
            {
        ...
        public ILine ShortestLineBetween(Point2DD pt, IPath path)
        {
            ILine result = null;
        ...
        public ILine ShortestLineBetween(Point2DD pt, IRegion region)
        {
            ILine result = null;
            double resultLength = double.MaxValue;
        ...
        public ILine ShortestLineBetween(IInfiniteLine infLine, Point2DD pt) => ShortestLineBetween(pt, infLine).Reverse();
        ...
        public ILine ShortestLineBetween(IInfiniteLine infLine, IPathSegment segment)
        {
            if (segment is ILine line)
            {
        ...
        public ILine ShortestLineBetween(IInfiniteLine infLine, IPath path)
        {
        ...
        public ILine ShortestLineBetween(IRay ray, Point2DD pt) => ShortestLineBetween(pt, ray).Reverse();
        ...
        public ILine ShortestLineBetween(IRay ray, IPathSegment segment)
        {
            if (segment is ILine line)
            {
        ...
        public ILine ShortestLineBetween(IRay ray, IPath path)
        {
        ...
        public ILine ShortestLineBetween(ILine line, Point2DD pt) => ShortestLineBetween(pt, line).Reverse();
        ...
        public ILine ShortestLineBetween(ICircle circle, Point2DD pt) => ShortestLineBetween(pt, circle).Reverse();
        ...
        public ILine ShortestLineBetween(IArc arc, Point2DD pt) => ShortestLineBetween(pt, arc).Reverse();
        ...
        public ILine ShortestLineBetween(IPathSegment segment, Point2DD pt) => ShortestLineBetween(pt, segment).Reverse();
        public ILine ShortestLineBetween(IPathSegment segment, IInfiniteLine infLine) => ShortestLineBetween(infLine, segment).Reverse();
        public ILine ShortestLineBetween(IPathSegment segment, IRay ray) => ShortestLineBetween(ray, segment).Reverse();
        public ILine ShortestLineBetween(IPathSegment segment1, IPathSegment segment2)
        {
            if (segment1 is ILine line1)
            {
                if (segment2 is ILine line2)
        ...
        public ILine ShortestLineBetween(IPath path, Point2DD pt) => ShortestLineBetween(pt, path).Reverse();
        public ILine ShortestLineBetween(IPath path, IInfiniteLine infLine) => ShortestLineBetween(infLine, path).Reverse();
        public ILine ShortestLineBetween(IPath path, IRay ray) => ShortestLineBetween(ray, path).Reverse();
        public ILine ShortestLineBetween(IPath path, IPathSegment segment)
        {
            ILine result = null;
            double resultLength = double.MaxValue;
            foreach (var asegment in path.Segments)
        ...
        public ILine ShortestLineBetween(IPath path1, IPath path2)
        {
            ILine result = null;
            double resultLength = double.MaxValue;
        ...
        public ILine ShortestLineBetween(IRegion region, Point2DD pt) => ShortestLineBetween(pt, region).Reverse();
        ...
        public ILine ShortestLineBetween(IRegion region, IPathSegment segment)
        {
            ILine result = null;
            double resultLength = double.MaxValue;
            foreach (var asegment in region.Paths.SelectMany(x => x.Segments))
        ...
        public ILine ShortestLineBetween(IRegion region, IPath path)
        {
            ILine result = null;
            double resultLength = double.MaxValue;
        ...
        public IEnumerable<Point2DD> Intersections(Point2DD pt1, Point2DD pt2)
        {
        ...
        public IEnumerable<Point2DD> Intersections(Point2DD pt, IInfiniteLine infLine) => Intersections(infLine, pt);
        public IEnumerable<Point2DD> Intersections(Point2DD pt, IRay ray) => Intersections(ray, pt);
        public IEnumerable<Point2DD> Intersections(Point2DD pt, ILine line) => Intersections(line, pt);
        public IEnumerable<Point2DD> Intersections(Point2DD pt, ICircle circle) => Intersections(circle, pt);
        public IEnumerable<Point2DD> Intersections(Point2DD pt, IArc arc) => Intersections(arc, pt);
        public IEnumerable<Point2DD> Intersections(Point2DD pt, IPathSegment segment) => Intersections(segment, pt);
        public IEnumerable<Point2DD> Intersections(Point2DD pt, IPath path) => Intersections(path, pt);
        public IEnumerable<Point2DD> Intersections(Point2DD pt, IRegion region) => Intersections(region, pt);

        public IEnumerable<Point2DD> Intersections(IInfiniteLine line, Point2DD pt)
        {
            var points = new UniquePointList(1, this);
        ...
        public IEnumerable<Point2DD> Intersections(IInfiniteLine infLine1, IInfiniteLine infLine2)
        {
            var points = new UniquePointList(1, this);
            var ir = Math2D.Intersection(infLine1, infLine2);
        ...
        public IEnumerable<Point2DD> Intersections(IInfiniteLine infLine, IRay ray)
        {
            var points = new UniquePointList(1, this);
        ...
        public IEnumerable<Point2DD> Intersections(IInfiniteLine infLine, ILine line)
        {
            var points = new UniquePointList(1, this);
        ...
        public IEnumerable<Point2DD> Intersections(IInfiniteLine infLine, ICircle circle)
        {
        ...
        public IEnumerable<Point2DD> Intersections(IInfiniteLine infLine, IArc arc)
        {
            var points = new UniquePointList(2, this);
        ...
        public IEnumerable<Point2DD> Intersections(IInfiniteLine infLine, IPathSegment segment)
        {
            if (segment is ILine line)
            {
        ...
        public IEnumerable<Point2DD> Intersections(IInfiniteLine infLine, IPath path)
        {
            return path.Segments.SelectMany(x => Intersections(infLine, x));
        }

        public IEnumerable<Point2DD> Intersections(IInfiniteLine infLine, IRegion region)
        {
            return region.Paths.SelectMany(x => Intersections(infLine, x));
        }

        public IEnumerable<Point2DD> Intersections(IRay ray, Point2DD pt)
        {
            var points = new UniquePointList(1, this);
        ...
        public IEnumerable<Point2DD> Intersections(IRay ray, IInfiniteLine infLine) => Intersections(infLine, ray);
        public IEnumerable<Point2DD> Intersections(IRay ray1, IRay ray2)
        {
            var points = new UniquePointList(1, this);
        ...
        public IEnumerable<Point2DD> Intersections(IRay ray, ILine line)
        {
            var points = new UniquePointList(1, this);
        ...
        public IEnumerable<Point2DD> Intersections(IRay ray, ICircle circle)
        {
            var points = new UniquePointList(2, this);
        ...
        public IEnumerable<Point2DD> Intersections(IRay ray, IArc arc)
        {
            var points = new UniquePointList(2, this);
        ...
        public IEnumerable<Point2DD> Intersections(IRay ray, IPathSegment segment)
        {
            if (segment is ILine line)
            {
        ...
        public IEnumerable<Point2DD> Intersections(IRay ray, IPath path)
        {
            return path.Segments.SelectMany(x => Intersections(ray, x));
        }

        public IEnumerable<Point2DD> Intersections(IRay ray, IRegion region)
        {
            return region.Paths.SelectMany(x => Intersections(ray, x));
        }

        public IEnumerable<Point2DD> Intersections(ILine line, Point2DD pt)
        {
            var points = new UniquePointList(1, this);
            var tp = (pt + pt.ProjectTo(line)) / 2;
        ...
        public IEnumerable<Point2DD> Intersections(ILine line, IInfiniteLine infLine) => Intersections(infLine, line);
        public IEnumerable<Point2DD> Intersections(ILine line, IRay ray) => Intersections(ray, line);

        public IEnumerable<Point2DD> Intersections(ILine line1, ILine line2)
        {
            var points = new UniquePointList(1, this);
        ...
        public IEnumerable<Point2DD> Intersections(ILine line, ICircle circle) => Intersections(circle, line);
        public IEnumerable<Point2DD> Intersections(ILine line, IArc arc) => Intersections(arc, line);

        public IEnumerable<Point2DD> Intersections(ICircle circle, Point2DD pt)
        {
            var points = new UniquePointList(1, this);
            var vu = (pt - circle.Center).Unit();
        ...
        public IEnumerable<Point2DD> Intersections(ICircle circle, IInfiniteLine infLine) => Intersections(infLine, circle);
        public IEnumerable<Point2DD> Intersections(ICircle circle, IRay ray) => Intersections(ray, circle);

        public IEnumerable<Point2DD> Intersections(ICircle circle, ILine line)
        {
            var points = new UniquePointList(2, this);
        ...
        public IEnumerable<Point2DD> Intersections(ICircle circle1, ICircle circle2)
        {
            var points = new UniquePointList(2, this);
        ...
        public IEnumerable<Point2DD> Intersections(ICircle circle, IArc arc) => Intersections(arc, circle);

        public IEnumerable<Point2DD> Intersections(IArc arc, Point2DD pt)
        {
            var points = new UniquePointList(1, this);
            var vu = (pt - arc.Center).Unit();
        ...
        public IEnumerable<Point2DD> Intersections(IArc arc, IInfiniteLine infLine) => Intersections(infLine, arc);
        public IEnumerable<Point2DD> Intersections(IArc arc, IRay ray) => Intersections(ray, arc);

        public IEnumerable<Point2DD> Intersections(IArc arc, ILine line)
        {
            var points = new UniquePointList(2, this);
        ...
        public IEnumerable<Point2DD> Intersections(IArc arc, ICircle circle)
        {
            var points = new UniquePointList(2, this);
        ...
        public IEnumerable<Point2DD> Intersections(IArc arc1, IArc arc2)
        {
            var points = new UniquePointList(2, this);
        ...
        public IEnumerable<Point2DD> Intersections(IPathSegment segment, Point2DD point)
        {
            if (segment is ILine line)
            {
        ...
        public IEnumerable<Point2DD> Intersections(IPathSegment segment, IInfiniteLine infLine) => Intersections(infLine, segment);
        public IEnumerable<Point2DD> Intersections(IPathSegment segment, IRay ray) => Intersections(ray, segment);

        public IEnumerable<Point2DD> Intersections(IPathSegment segment1, IPathSegment segment2)
        {
            if (segment1 is ILine line1)
            {
                if (segment2 is ILine line2)
        ...
        public IEnumerable<Point2DD> Intersections(IPath path, Point2DD point)
        {
        ...
        public IEnumerable<Point2DD> Intersections(IPath path, IInfiniteLine infLine) => Intersections(infLine, path);
        public IEnumerable<Point2DD> Intersections(IPath path, IRay ray) => Intersections(ray, path);

        public IEnumerable<Point2DD> Intersections(IPath path, IPathSegment segment)
        {
            var result = new UniquePointList(1, this);
            foreach (var asegment in path.Segments)
            {
        ...
        public IEnumerable<Point2DD> Intersections(IPath path1, IPath path2)
        {
            var result = new UniquePointList(1, this);
            foreach (var asegment1 in path1.Segments)
            {
        ...
        public IEnumerable<Point2DD> Intersections(IRegion region, Point2DD point)
        {
            var result = new UniquePointList(1, this);
            foreach (var asegment in region.Paths.SelectMany(x => x.Segments))
            {
        ...
        public IEnumerable<Point2DD> Intersections(IRegion region, IInfiniteLine infLine) => Intersections(infLine, region);
        public IEnumerable<Point2DD> Intersections(IRegion region, IRay ray) => Intersections(ray, region);

        public IEnumerable<Point2DD> Intersections(IRegion region, IPathSegment segment)
        {
            var result = new UniquePointList(1, this);
            foreach (var asegment in region.Paths.SelectMany(x => x.Segments))
            {
        ...
        public IEnumerable<Point2DD> Intersections(IRegion region, IPath path)
        {
            var result = new UniquePointList(1, this);
            foreach (var asegment1 in region.Paths.SelectMany(x => x.Segments))
            {
        ...
        public IEnumerable<Point2DD> Intersections(IRegion region1, IRegion region2)
        {
            var result = new UniquePointList(1, this);
            foreach (var asegment1 in region1.Paths.SelectMany(x => x.Segments))
            {
        ...
        private class UniquePointList : List<Point2DD>
        {
            ...
            public new void Add(Point2DD point)
            {
                if (!this.Any(x => geometry2DEngine.AreCoincident(x, point)))
                    base.Add(point);
            }

            public new void AddRange(IEnumerable<Point2DD> points)
            {
        ...
        public Point2DD? FirstIntersection(Point2DD pt1, Point2DD pt2)
        {
            return AreCoincident(pt1, pt2) ? (Point2DD?)pt1 : null;
        }

        public Point2DD? FirstIntersection(Point2DD pt, IInfiniteLine infLine) => FirstIntersection(infLine, pt);
        public Point2DD? FirstIntersection(Point2DD pt, IRay ray) => FirstIntersection(ray, pt);
        public Point2DD? FirstIntersection(Point2DD pt, ILine line) => FirstIntersection(line, pt);
        public Point2DD? FirstIntersection(Point2DD pt, ICircle circle) => FirstIntersection(circle, pt);
        public Point2DD? FirstIntersection(Point2DD pt, IArc arc) => FirstIntersection(arc, pt);
        public Point2DD? FirstIntersection(Point2DD pt, IPathSegment segment) => FirstIntersection(segment, pt);
        public Point2DD? FirstIntersection(Point2DD pt, IPath path) => FirstIntersection(path, pt);
        public Point2DD? FirstIntersection(Point2DD pt, IRegion region) => FirstIntersection(region, pt);

        public Point2DD? FirstIntersection(IInfiniteLine line, Point2DD pt)
        {
            var p = pt.ProjectTo(line);
            return AreCoincident(p, pt) ? (Point2DD?)pt : null;
        }

        public Point2DD? FirstIntersection(IInfiniteLine infLine1, IInfiniteLine infLine2)
        {
            var sl = ShortestLineBetween(infLine1, infLine2);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IInfiniteLine infLine, IRay ray)
        {
            var sl = ShortestLineBetween(infLine, ray);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IInfiniteLine infLine, ILine line)
        {
            var sl = ShortestLineBetween(infLine, line);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IInfiniteLine infLine, ICircle circle)
        {
            var sl = ShortestLineBetween(infLine, circle);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IInfiniteLine infLine, IArc arc)
        {
            var sl = ShortestLineBetween(infLine, arc);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IInfiniteLine infLine, IPathSegment segment)
        {
            var sl = ShortestLineBetween(infLine, segment);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IInfiniteLine infLine, IPath path)
        {
            var sl = ShortestLineBetween(infLine, path);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IInfiniteLine infLine, IRegion region)
        {
            var sl = ShortestLineBetween(infLine, region);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IRay ray, Point2DD pt)
        {
            if (AreCoincident(pt, ray.Point1)) return pt;
            var p = pt.ProjectTo(ray);
            if (!AreCoincident(pt, p)) return null;
            return (p - ray.Point1) * ray.Vector >= 0 ? (Point2DD?)pt : null;
        }

        public Point2DD? FirstIntersection(IRay ray, IInfiniteLine infLine)
        {
            var sl = ShortestLineBetween(ray, infLine);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IRay ray1, IRay ray2)
        {
            var sl = ShortestLineBetween(ray1, ray2);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IRay ray, ILine line)
        {
            var sl = ShortestLineBetween(ray, line);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IRay ray, ICircle circle)
        {
            var sl = ShortestLineBetween(ray, circle);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IRay ray, IArc arc)
        {
            var sl = ShortestLineBetween(ray, arc);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IRay ray, IPathSegment segment)
        {
            var sl = ShortestLineBetween(ray, segment);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IRay ray, IPath path)
        {
            var sl = ShortestLineBetween(ray, path);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IRay ray, IRegion region)
        {
            var sl = ShortestLineBetween(ray, region);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(ILine line, Point2DD pt)
        {
            return AreCoincident(line, pt) ? (Point2DD?)pt : null;
        }

        public Point2DD? FirstIntersection(ILine line, IInfiniteLine infLine)
        {
            var sl = ShortestLineBetween(line, infLine);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(ILine line, IRay ray)
        {
            var sl = ShortestLineBetween(line, ray);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(ILine line1, ILine line2)
        {
            var sl = ShortestLineBetween(line1, line2);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(ILine line, ICircle circle)
        {
            var sl = ShortestLineBetween(line, circle);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(ILine line, IArc arc)
        {
            var sl = ShortestLineBetween(line, arc);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(ILine line, IPathSegment segment)
        {
            var sl = ShortestLineBetween(line, segment);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(ICircle circle, Point2DD pt)
        {
            return AreCoincident(circle, pt) ? (Point2DD?)pt : null;
        }

        public Point2DD? FirstIntersection(ICircle circle, IInfiniteLine infLine)
        {
            var sl = ShortestLineBetween(circle, infLine);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(ICircle circle, IRay ray)
        {
            var sl = ShortestLineBetween(circle, ray);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(ICircle circle, ILine line)
        {
            var sl = ShortestLineBetween(circle, line);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(ICircle circle1, ICircle circle2)
        {
            var sl = ShortestLineBetween(circle1, circle2);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(ICircle circle, IArc arc) => FirstIntersection(arc, circle);

        public Point2DD? FirstIntersection(IArc arc, Point2DD pt)
        {
            return AreCoincident(arc, pt) ? (Point2DD?)pt : null;
        }

        public Point2DD? FirstIntersection(IArc arc, IInfiniteLine infLine)
        {
            var sl = ShortestLineBetween(arc, infLine);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IArc arc, IRay ray)
        {
            var sl = ShortestLineBetween(arc, ray);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IArc arc, ILine line)
        {
            var sl = ShortestLineBetween(arc, line);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IArc arc, ICircle circle)
        {
            var sl = ShortestLineBetween(arc, circle);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IArc arc1, IArc arc2)
        {
            var sl = ShortestLineBetween(arc1, arc2);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IPathSegment segment, Point2DD point)
        {
            if (segment is ILine line)
            {
        ...
        public Point2DD? FirstIntersection(IPathSegment segment, IInfiniteLine infLine)
        {
            var sl = ShortestLineBetween(segment, infLine);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IPathSegment segment, IRay ray)
        {
            var sl = ShortestLineBetween(segment, ray);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IPathSegment segment1, IPathSegment segment2)
        {
            if (segment1 is ILine line1)
            {
                if (segment2 is ILine line2)
        ...
        public Point2DD? FirstIntersection(IPath path, Point2DD point)
        {
            Point2DD? result = null;
            foreach (var asegment in path.Segments)
            {
        ...
        public Point2DD? FirstIntersection(IPath path, IInfiniteLine infLine)
        {
            var sl = ShortestLineBetween(path, infLine);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IPath path, IRay ray)
        {
            var sl = ShortestLineBetween(path, ray);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IPath path, IPathSegment segment)
        {
            Point2DD? result = null;
            foreach (var asegment in path.Segments)
            {
        ...
        public Point2DD? FirstIntersection(IPath path1, IPath path2)
        {
            Point2DD? result = null;
            foreach (var asegment1 in path1.Segments)
            {
        ...
        public Point2DD? FirstIntersection(IRegion region, Point2DD point)
        {
            Point2DD? result = null;
            foreach (var asegment1 in region.Paths.SelectMany(x => x.Segments))
            {
        ...
        public Point2DD? FirstIntersection(IRegion region, IInfiniteLine infLine)
        {
            var sl = ShortestLineBetween(region, infLine);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IRegion region, IRay ray)
        {
            var sl = ShortestLineBetween(region, ray);
            return AreCoincident(sl.StartPoint, sl.EndPoint) ? (Point2DD?)sl.StartPoint : null;
        }

        public Point2DD? FirstIntersection(IRegion region, IPathSegment segment)
        {
            Point2DD? result = null;
            foreach (var asegment1 in region.Paths.SelectMany(x => x.Segments))
            {
        ...
        public Point2DD? FirstIntersection(IRegion region, IPath path)
        {
            Point2DD? result = null;
            foreach (var asegment1 in region.Paths.SelectMany(x => x.Segments))
            {
        ...
        public Point2DD? FirstIntersection(IRegion region1, IRegion region2)
        {
            Point2DD? result = null;
            foreach (var asegment1 in region1.Paths.SelectMany(x => x.Segments))
            {
        ...
        public IPathBuilder CreatePathBuilder() => new PathBuilder(this);
        ...
        public IPath Reduce(IPath path)
        {
        ...
        public IEnumerable<IPath> FindCommonPaths(IPath path1, IPath path2)
        {
            Func<IPath, IPath, IReadOnlyList<IPathSegment>> addExtraVertices = (pathToExtend, otherPath) =>
            {
                // collect intersection points that are not path's vertices
                var splitPointMap = new Dictionary<IPathSegment, UniquePointList>();
                Action<IPathSegment, Point2DD> addSplitPointIfNeed = (segment, splitPoint) =>
                {
                ...
                var extendedSegments = new List<IPathSegment>(pathToExtend.Segments.Count + splitPointMap.Values.Sum(x => x.Count));
                foreach (var segment in pathToExtend.Segments)
                {
            ...
            var result = new List<IPath>(commonPaths.Count);
        ...
        private LinkedList<LinkedList<Tuple<IPathSegment, IPathSegment>>> FindCommonPaths(IReadOnlyList<IPathSegment> path1, IReadOnlyList<IPathSegment> path2, bool reversePath2, Func<IPathSegment, IPathSegment, bool> areCommonCheck = null)
        {
            ...
            var commonSegmentGroups = new LinkedList<LinkedList<Tuple<IPathSegment, IPathSegment>>>();
            LinkedList<Tuple<IPathSegment, IPathSegment>> currentCommonSegmentGroup = null;
            var enum1 = new PathSegmentIterator(path1, null).Segments.GetEnumerator();
            IEnumerator<IPathSegment> enum2 = null;
            ...
            do
            {
                ...
                if (firstCommonSegmentFound)
                {
                    ...
                    currentCommonSegmentGroup = new LinkedList<Tuple<IPathSegment, IPathSegment>>();
                    currentCommonSegmentGroup.AddLast(new Tuple<IPathSegment, IPathSegment>(enum1.Current, reversePath2 ? enum2.Current.Reverse() : enum2.Current));
        ...
        public IEnumerable<IPath> FindCommonPaths(IRegion region1, IRegion region2)
        {
        ...
        public IRectangle FindMinimalRectangleAroundPath(IPath path, Vector2DD? direction = null)
        {
            Func<Vector2DD, IPath, IRectangle> calcMinRectInDirection = (baseVector, apath) =>
            {
            ...
            var aarect = calcMinRectInDirection(new Vector2DD(1, 0), path);
        ...
        public IPolygon FindMinimalPoly4AroundPath(IPath path)
        {
            Func<IInfiniteLine, IPath, IInfiniteLine> findClosestLine = (aline, apath) =>
            {
                var closestLine = aline;
                var error = Vector2DD.Zero;
                do
                {
                    ...
                    var outsidePoints = new List<Point2DD>();
                    foreach (var s in apath.Segments)
                    {
        ...
        public IPath Offset(IPath path, double offset, OffsetMode mode)
        {
            if (path.Winding == 0)
                throw new ArgumentException("Path must be closed and have nonzero winding", nameof(path));
            var newSegments = new LinkedList<IPathSegment>();
            foreach (var segment in path.Segments)
            {
            ...
            var pathBuilder = new PathBuilder(this);
            pathBuilder.BeginPath();
            pathBuilder.Add(newSegments);
            return pathBuilder.EndPath(true);
        }

        public double ComputeMaxDiff(IPath path1, IPath path2)
        {
            double result = 0;
            var pathVertexIterator1 = new PathVertexIterator(path1);
            ...
            var pathVertexIterator2 = new PathVertexIterator(path2);
        ...
        public IPath SnapPathToRefPath(IPath pathToSnap, IPath refPath, double distanceThreshold)
        {
            Func<IPath, IPath, IReadOnlyList<IPathSegment>> addExtraVertices = (pathToExtend, otherPath) =>
            {
                ...
                // closest points
                var otherPathVertexIterator = new PathVertexIterator(otherPath);
            ...
            Func<IPathSegment, IPathSegment, bool> areCommonCheck = (segment1, segment2) =>
            {
        ...
        {
            private readonly IReadOnlyList<IPathSegment> path;
            private readonly bool isClosed;
            private readonly int startSegmentIndex;
            private readonly bool reverse;

            public PathSegmentIterator(IReadOnlyList<IPathSegment> path, int startSegmentIndex, bool reverse = false)
            {
                this.path = path;
            ...
            public PathSegmentIterator(IReadOnlyList<IPathSegment> path, IPathSegment startSegment, bool reverse = false)
            {
                this.path = path;
                isClosed = path.Count != 0 && path.First().StartPoint == path.Last().EndPoint;
